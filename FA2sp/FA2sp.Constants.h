...
#define RAZER_PRODUCT_VERSION HDM Edition HE_PRODUCT_STR
#define PROGRAM_TITLE FinalAlert 2 SP: RAZER_PRODUCT_VERSION
...
#define APPLY_INFO "Found Final Alert 2 version 1.02. Applying " VERSION_STRVER ", " __str(RAZER_PRODUCT_VERSION)
